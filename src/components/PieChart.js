...
const PieChart = ({ homePercentage, awayColor = 'black', homeColor = 'red', width = '100%' }) => {
  ...
  return (
    <svg viewBox="0 0 32 32" className="pie-chart" style={{ width: width, borderRadius: '50%', transform: 'rotate(-90deg)' }}>
      <circle r="16" cx="16" cy="16" fill={homeColor} stroke={awayColor} 
